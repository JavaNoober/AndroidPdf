...
import com.xiaoqi.pdftools.util.DragPinchListener;
import com.xiaoqi.pdftools.util.DragPinchListener.OnDoubleTapListener;
import com.xiaoqi.pdftools.util.DragPinchListener.OnDragListener;
import com.xiaoqi.pdftools.util.DragPinchListener.OnPinchListener;

import static com.xiaoqi.pdftools.util.Constants.Pinch.*;
import static com.xiaoqi.pdftools.util.Constants.Pinch.MAXIMUM_ZOOM;
import static com.xiaoqi.pdftools.util.Constants.Pinch.MINIMUM_ZOOM;
import static com.xiaoqi.pdftools.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_DISTANCE;
import static com.xiaoqi.pdftools.util.Constants.Pinch.QUICK_MOVE_THRESHOLD_TIME;
